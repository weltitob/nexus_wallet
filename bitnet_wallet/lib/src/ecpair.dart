...
class ECPair {
  ...
  factory ECPair.fromWIF(String w, {required NetworkType network}) {
  ...
  factory ECPair.fromPublicKey(Uint8List publicKey,
      {required NetworkType network, required bool compressed}) {
  ...
  factory ECPair.makeRandom(
      {required NetworkType network, required bool compressed, required Function rng}) {
